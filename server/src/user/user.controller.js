...
var UserController = /** @class */ (function () {
    ...
    UserController.prototype.profile = function (req) {
        return req.user;
    };
    UserController.prototype.getUsernames = function () {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                return [2 /*return*/, this.userService.getUsernames()];
            });
        });
    };
    __decorate([
    ...
    ], UserController.prototype, "getUsernames");
    UserController = __decorate([
        (0, common_1.Controller)(name_const_1.UserDomainName)
    ], UserController);
